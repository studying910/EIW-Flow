from denseflow.data.datasets.image import UnsupervisedCIFAR10, CIFAR10Dataset, CIFAR10SemiSupDataset, \
    CIFAR10PerturbedDataset
...
class CIFAR10SemiSup(TrainTestLoader):
    ...
    def __init__(self, num_samples, root=DATA_PATH, download=True, num_bits=8, pil_transforms=[]):
        ...
        # Load data
        self.train_sup = CIFAR10SemiSupDataset(num_samples, root, train=True, transform=Compose(trans_train),
                                               download=download)
