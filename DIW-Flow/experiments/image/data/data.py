...
from denseflow.data.loaders.image import CIFAR10, ImageNet32, ImageNet64, SVHN, MNIST, CIFAR10Supervised, SVHNSupervised, CIFAR100Supervised, CelebA

dataset_choices = {'cifar10', 'cifar10sup', 'cifar100sup', 'imagenet32', 'imagenet64', 'svhn', 'svhnsup', 'mnist', 'celeba'}
